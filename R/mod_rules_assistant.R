...
mod_rules_assistant_ui <- function(
  id,
  ...
  tagList(
    div(
      class = "rules-assistant-container",
      shinychat::chat_ui(
        id = ns("chat"),
...
#' rules_assistant Server Functions
#'
#' @param id Module id
...
#'
#' @noRd
mod_rules_assistant_server <- function(
  id,
  rules_content,
  rules_type = "rules",
...
# mod_rules_assistant_ui("rules_assistant_1",
...
# mod_rules_assistant_server("rules_assistant_1",
